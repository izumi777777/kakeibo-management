...
class Memo(db.Model):
    ...
    item_category = db.Column(db.String(20), default='other')   # food / daily / other
    week          = db.Column(db.Integer, default=1)             # 1〜4（給料日サイクルの週）
    price         = db.Column(db.Integer, default=0)             # 金額（任意）
